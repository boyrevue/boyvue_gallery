...
// Site definitions
const SITES = [
  { id: 'main', name: 'BoyVue Main', url: 'https://boyvue.com', color: '#f60' },
  { id: 'adult', name: 'Adult', url: 'https://adult.boyvue.com', color: '#ff1493' },
  { id: 'videos', name: 'Videos', url: 'https://videos.boyvue.com', color: '#00d4ff' },
  { id: 'fans', name: 'Fans/Creatives', url: 'https://fans.boyvue.com', color: '#9c27b0' },
];
  ...
  return (
    <div className="unified-admin">
      ...
      <main className="admin-content">
        {/* Main Site - Show link to full admin */}
        {activeSite === 'main' && (
          <div className="site-panel">
            <div className="info-card">
              <h2>BoyVue Main Site Admin</h2>
              <p>The main admin dashboard has comprehensive features for SEO, analytics, i18n, and more.</p>
              <div className="action-buttons">
                <a href="/admin/full" className="primary-btn">Open Full Admin Dashboard</a>
              </div>
            </div>
            <SeoAdmin
              siteName="BoyVue Main"
