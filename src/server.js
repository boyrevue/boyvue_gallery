...
app.get('/robots.txt', (req, res) => {
  res.type('text/plain').send(`# Robots.txt for BoyVue.com
User-agent: *
Allow: /
Disallow: /api/

# Sitemaps
Sitemap: https://boyvue.com/sitemap.xml
Sitemap: https://boyvue.com/video-sitemap.xml
Sitemap: https://boyvue.com/image-sitemap.xml
`);
});

// SEO: Sitemap index for large sites
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <sitemap><loc>https://boyvue.com/sitemap-images.xml</loc></sitemap>
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url><loc>https://boyvue.com/</loc><changefreq>daily</changefreq><priority>1.0</priority></url>`;
    ...
    console.error('Categories sitemap error:', e.message);
    res.status(500).send('Error generating sitemap');
  }
});

// Video pages sitemaps (split into chunks for large sites)
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">`;
    ...
    console.error('Videos sitemap error:', e.message);
    res.status(500).send('Error generating sitemap');
  }
});

// Images sitemap alias
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:video="http://www.google.com/schemas/sitemap-video/1.1">`;
  ...
  <url>
    ...
    console.error('Video sitemap error:', e.message);
    res.status(500).send('Error generating video sitemap');
  }
});

// SEO: Image sitemap for better image indexing
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1">`;
  ...
  <url>
    ...
    console.error('Image sitemap error:', e.message);
