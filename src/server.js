...
<div class="share">
  ...
  <a href="${shares.twitter}" target="_blank" rel="noopener" class="tw">𝕏 Twitter</a>
  ...
  <a href="${shares.email}" class="em">📧 Email</a>
</div>
</main>
...
app.get('/c/:id', async (req, res) => {
  ...
  try {
    ...
    const meta = {
      title: `${name} | BoyVue Gallery`,
      description: `${bl} ${pc} photos and videos in ${name}. Free HD streaming.`,
      image: coverImage
    };
